            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Text
                      className="bg-gray_300 font-bold leading-lh lg:mt-[24px] xl:mt-[28px] 2xl:mt-[31px] 3xl:mt-[38px] mt-[42.44px] lg:mx-[19px] xl:mx-[22px] 2xl:mx-[25px] 3xl:mx-[30px] mx-[34px] lg:px-[20px] xl:px-[23px] 2xl:px-[26px] 3xl:px-[31px] px-[35px] 3xl:py-[11px] py-[12.830017px] lg:py-[7px] xl:py-[8px] 2xl:py-[9px] rounded-radius38 text-black_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 w-[28%]"
                      compId="1:591"
                      comWidth={197}
                      comHeight={59.22}
                      compLeft={34}
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >{`08:00 AM - 04:30 PM`}</Text>
                      <Text
                        className="font-lora font-medium mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] mt-[10.85px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left text-white_A700 w-[94%]"
                        compId="212:5"
                        comWidth={332}
                        comHeight={30.6}
                        compLeft={0}
                      ...
                      >{`Club Sponsorships 2020-2021`}</Text>
                      <Text
                        className="font-cairo font-normal lg:leading-lh16 xl:leading-lh18 2xl:leading-lh21 3xl:leading-lh25 leading-lh2800 xl:mt-[3px] lg:mt-[3px] 2xl:mt-[4px] mt-[5.92px] 3xl:mt-[5px] not-italic xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-gray_300 text-left w-[100%]"
                        compId="212:7"
                        comWidth={355}
                        comHeight={55.27}
                        compLeft={0}
              ...
              >
                ...
                >
                  ...
                  >{`Why Join Elmna`}</Text>
                  <Text
                    className="font-cairo font-normal lg:leading-lh14 xl:leading-lh16 2xl:leading-lh18 3xl:leading-lh21 leading-lh2400 lg:ml-[287px] xl:ml-[328px] 2xl:ml-[369px] 3xl:ml-[443px] ml-[492px] lg:mr-[277px] xl:mr-[316px] 2xl:mr-[356px] 3xl:mr-[427px] mr-[475px] lg:mt-[17px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] mt-[30.6px] not-italic text-black_902 text-center xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 w-[40%]"
                    compId="1:394"
                    comWidth={635}
                    comHeight={47.38}
                    compLeft={492}
              ...
              >
                ...
                >
                  ...
                  <Text
                    className="font-normal lg:leading-lh18 xl:leading-lh21 2xl:leading-lh24 3xl:leading-lh28 leading-lh3200 mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[21px] mt-[23.69px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_700 text-left w-[85%]"
                    compId="25:275"
                    comWidth={805}
                    comHeight={157.92}
                    compLeft={0}
                  ...
                  />
                  <Text
                    className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[21px] mt-[23.68px] not-italic text-black_902 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[12%]"
                    compId="25:276"
                    comWidth={113}
                    comHeight={31.58}
                    compLeft={0}
              ...
              >
                ...
                >
                  ...
                  >
                    <Text
                      className="font-cairo font-semibold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left text-yellow_600 uppercase w-[31%]"
                      compId="36:77"
                      comWidth={207}
                      comHeight={44.41}
                      compLeft={0}
                    ...
                    <Text
                      className="font-bold font-lora mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] xl:mt-[5px] lg:mt-[5px] 2xl:mt-[6px] mt-[8.89px] 3xl:mt-[8px] lg:text-fs35 xl:text-fs40 2xl:text-fs45 3xl:text-fs54 text-fs60 text-gray_300 text-left w-[64%]"
                      compId="36:74"
                      comWidth={431}
                      comHeight={76}
                      compLeft={0}
                    ...
                    >{`Roberto Karloz`}</Text>
                    <Text
                      className="font-cairo font-normal leading-lh 3xl:mt-[11px] mt-[12.83px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] not-italic xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-gray_300 text-left w-[100%]"
                      compId="36:73"
                      comWidth={669}
                      comHeight={148.05}
                      compLeft={0}
                  ...
                  >
                    ...
                    >
                      <Text
                        className="font-bold 3xl:my-[11px] my-[12.83px] lg:my-[7px] xl:my-[8px] 2xl:my-[9px] text-black_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[37%]"
                        compId="36:89"
                        comWidth={86}
                        comHeight={33.56}
                        compLeft={0}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >{`MOBILE APP`}</Text>
                        <Text
                          className="font-bold font-lora lg:ml-[17px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] ml-[30px] lg:mr-[16px] xl:mr-[19px] 2xl:mr-[21px] 3xl:mr-[26px] mr-[29.06px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] mt-[6.69px] 3xl:mt-[6px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                          compId="32:125"
                          comWidth={449.94}
                          comHeight={27.65}
                          compLeft={30}
                    ...
                    >
                      ...
                      >
                        ...
                        >{`ART EXIBITHION`}</Text>
                        <Text
                          className="font-bold font-lora lg:ml-[17px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] ml-[30px] lg:mr-[16px] xl:mr-[19px] 2xl:mr-[21px] 3xl:mr-[26px] mr-[29.06px] xl:mt-[3px] lg:mt-[3px] 2xl:mt-[4px] mt-[5.91px] 3xl:mt-[5px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                          compId="36:23"
                          comWidth={449.94}
                          comHeight={27.65}
                          compLeft={30}
                    ...
                    >
                      ...
                      >
                        ...
                        >{`ACCOUNTING`}</Text>
                        <Text
                          className="font-bold font-lora leading-lh lg:ml-[17px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] ml-[30px] lg:mr-[16px] xl:mr-[19px] 2xl:mr-[21px] 3xl:mr-[26px] mr-[29px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] mt-[6.69px] 3xl:mt-[6px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                          compId="36:42"
                          comWidth={450}
                          comHeight={53.31}
                          compLeft={30}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Text
                    className="font-semibold text-black_900 xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-right w-[9%]"
                    compId="1:44"
                    comWidth={171}
                    comHeight={30}
                    compLeft={0}
