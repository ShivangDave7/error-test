        ...
        >
          ...
          >
            ...
            >
              ...
              >{`About Us`}</Text>
              <Text
                className="font-cairo font-normal lg:leading-lh16 xl:leading-lh18 2xl:leading-lh21 3xl:leading-lh25 leading-lh2800 lg:ml-[37px] 2xl:ml-[48px] 3xl:ml-[57px] ml-[64px] lg:mr-[36px] 2xl:mr-[47px] 3xl:mr-[56px] mr-[63px] lg:mt-[11px] xl:mt-[13px] 2xl:mt-[14px] 3xl:mt-[17px] mt-[19.83px] xl:mx-[42px] not-italic text-center xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-white_A700 w-[81%]"
                compId="25:707"
                comWidth={531}
                comHeight={55.5}
                compLeft={64}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  />
                  <Text
                    className="font-bold font-lora lg:leading-lh19 xl:leading-lh22 2xl:leading-lh25 3xl:leading-lh30 leading-lh3400 lg:mt-[26px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[40px] mt-[44.59px] mx-[auto] text-bluegray_801 text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 w-[55%]"
                    compId="29:116"
                    comWidth={178}
                    comHeight={67.39}
                    compLeft={26}
                  ...
                  <Text
                    className="font-cairo font-normal lg:mb-[23px] xl:mb-[27px] 2xl:mb-[30px] 3xl:mb-[36px] mb-[40.63px] lg:ml-[15px] xl:ml-[17px] 2xl:ml-[19px] 3xl:ml-[23px] ml-[26px] lg:mr-[14px] xl:mr-[16px] 2xl:mr-[18px] 3xl:mr-[22px] mr-[25px] mt-[10.91px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] not-italic text-bluegray_801 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 w-[84%]"
                    compId="29:115"
                    comWidth={273}
                    comHeight={27.75}
                    compLeft={26}
                ...
                >
                  ...
                  />
                  <Text
                    className="font-bold font-lora lg:leading-lh19 xl:leading-lh22 2xl:leading-lh25 3xl:leading-lh30 leading-lh3400 lg:mt-[26px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[40px] mt-[44.59px] mx-[auto] text-bluegray_801 text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 w-[84%]"
                    compId="29:130"
                    comWidth={272}
                    comHeight={67.39}
                    compLeft={26}
                ...
                >
                  ...
                  />
                  <Text
                    className="font-bold font-lora lg:leading-lh19 xl:leading-lh22 2xl:leading-lh25 3xl:leading-lh30 leading-lh3400 lg:mt-[26px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[40px] mt-[44.59px] mx-[auto] text-bluegray_801 text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 w-[82%]"
                    compId="29:123"
                    comWidth={264}
                    comHeight={67.39}
                    compLeft={25}
                  ...
                  <Text
                    className="font-cairo font-normal lg:mb-[23px] xl:mb-[27px] 2xl:mb-[30px] 3xl:mb-[36px] mb-[40.63px] mt-[10.91px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] mx-[auto] not-italic text-bluegray_801 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 w-[85%]"
                    compId="29:122"
                    comWidth={273}
                    comHeight={27.75}
                    compLeft={25}
                ...
                >
                  ...
                  />
                  <Text
                    className="font-bold font-lora lg:leading-lh19 xl:leading-lh22 2xl:leading-lh25 3xl:leading-lh30 leading-lh3400 lg:mt-[26px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[40px] mt-[44.59px] mx-[auto] text-bluegray_801 text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 w-[76%]"
                    compId="29:137"
                    comWidth={247}
                    comHeight={67.39}
                    compLeft={26}
                ...
                >
                  ...
                  />
                  <Text
                    className="font-bold font-lora lg:leading-lh19 xl:leading-lh22 2xl:leading-lh25 3xl:leading-lh30 leading-lh3400 lg:mt-[26px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[40px] mt-[44.59px] mx-[auto] text-bluegray_801 text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 w-[68%]"
                    compId="29:147"
                    comWidth={219}
                    comHeight={67.39}
                    compLeft={26}
          ...
          >
            ...
            >
              <Text
                className="capitalize font-bold font-lora lg:ml-[284px] 2xl:ml-[365px] 3xl:ml-[438px] ml-[487px] lg:mr-[283px] 2xl:mr-[364px] 3xl:mr-[437px] mr-[486px] xl:mx-[324px] text-black_902 text-center lg:text-fs35 xl:text-fs40 2xl:text-fs45 3xl:text-fs54 text-fs60 w-[40%]"
                compId="36:144"
                comWidth={647}
                comHeight={79.28}
                compLeft={487}
              ...
              <Text
                className="font-cairo font-normal leading-lh lg:mt-[16px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27.75px] mx-[auto] not-italic text-bluegray_801 text-center xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 w-[39%]"
                compId="36:143"
                comWidth={635}
                comHeight={59.46}
                compLeft={487}
              ...
              >
                ...
                >
                  ...
                  />
                  <Text
                    className="font-bold lg:mb-[12px] xl:mb-[13px] 2xl:mb-[15px] 3xl:mb-[18px] mb-[20.8px] ml-[42.47px] mr-[42.42px] lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[21px] mt-[23.79px] lg:mx-[24px] xl:mx-[28px] 2xl:mx-[31px] 3xl:mx-[38px] text-black_900 text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 w-[71%]"
                    compId="36:220"
                    comWidth={209}
                    comHeight={44.6}
                    compLeft={42.47}
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Text
                    className="font-normal lg:leading-lh16 xl:leading-lh18 2xl:leading-lh21 3xl:leading-lh25 leading-lh2800 lg:ml-[12px] xl:ml-[14px] 2xl:ml-[15px] 3xl:ml-[18px] ml-[21px] not-italic text-bluegray_801 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 w-[97%]"
                    compId="36:240"
                    comWidth={805}
                    comHeight={138.75}
                    compLeft={21}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Text
                          className="font-bold font-lora text-bluegray_801 lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-left w-[100%]"
                          compId="36:245"
                          comWidth={176}
                          comHeight={35.68}
                          compLeft={0}
              ...
              >
                ...
                >
                  ...
                  >{`Testimonials`}</Text>
                  <Text
                    className="font-cairo font-normal leading-lh lg:mt-[18px] xl:mt-[21px] 2xl:mt-[23px] 3xl:mt-[28px] mt-[31.71px] not-italic text-bluegray_801 xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-left w-[100%]"
                    compId="36:262"
                    comWidth={584}
                    comHeight={52.53}
                    compLeft={0}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Button
                    className="bg-gray_300 font-bold ml-[102px] lg:ml-[59px] xl:ml-[68px] 2xl:ml-[76px] 3xl:ml-[91px] mr-[10.21px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:my-[5px] xl:my-[6px] 2xl:my-[7px] 3xl:my-[8px] my-[9.91px] xl:pb-[10px] 2xl:pb-[11px] 3xl:pb-[13px] pb-[15.415px] lg:pb-[8px] 2xl:pt-[10px] 3xl:pt-[12px] pt-[13.435px] lg:pt-[7px] xl:pt-[8px] rounded-radius37 shadow-bs2 text-black_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 w-[36%]"
                    compId="25:4831"
                    comWidth={196.79}
                    comHeight={59.46}
                    compLeft={102}
