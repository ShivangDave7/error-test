          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Stack
                    className="font-lora lg:h-[103px] xl:h-[118px] 2xl:h-[133px] 3xl:h-[159px] h-[176px] lg:ml-[165px] 2xl:ml-[212px] 3xl:ml-[254px] ml-[283px] lg:mr-[164px] 2xl:mr-[211px] 3xl:mr-[253px] mr-[282px] xl:mx-[188px] w-[59%]"
                    compId="1198"
                    comWidth={804}
                    comHeight={176}
                    compLeft={283}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >{`ART EXIBITHION`}</Text>
                        <Text
                          className="font-bold font-lora xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.39px] xl:mt-[3px] lg:mt-[3px] 2xl:mt-[4px] mt-[5.99px] 3xl:mt-[5px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                          compId="44:76"
                          comWidth={449.94}
                          comHeight={28.01}
                          compLeft={30}
                      ...
                      >
                        <Row
                          className="bg-black_900 items-center justify-start lg:mr-[168px] xl:mr-[193px] 2xl:mr-[217px] 3xl:mr-[260px] mr-[289.33px] lg:mt-[119px] xl:mt-[136px] 2xl:mt-[153px] 3xl:mt-[184px] mt-[205px] rounded-radius6 w-[43%]"
                          compId="1177"
                          comWidth={220}
                          comHeight={113}
                          compLeft={0}
                        ...
                        >
                          ...
                          <Image
                            ...
                            className="lg:h-[35px] xl:h-[41px] 2xl:h-[46px] 3xl:h-[55px] h-[60px] lg:mb-[14px] xl:mb-[16px] 2xl:mb-[18px] 3xl:mb-[22px] mb-[25px] lg:ml-[30px] xl:ml-[35px] 2xl:ml-[39px] 3xl:ml-[47px] ml-[52.65px] lg:mt-[16px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] mt-[28px] object-contain lg:w-[35px] xl:w-[40px] 2xl:w-[45px] 3xl:w-[54px] w-[60px]"
                            compId="44:86"
                            comWidth={60}
                            comHeight={60}
                            compLeft={52.65}
                    ...
                    >
                      ...
                      >
                        ...
                        >{`MOBILE APP`}</Text>
                        <Text
                          className="font-bold font-lora xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.39px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] mt-[6.77px] 3xl:mt-[6px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                          compId="44:57"
                          comWidth={449.94}
                          comHeight={28.01}
                          compLeft={30}
                      ...
                      >
                        ...
                        >
                          ...
                          <Image
                            ...
                            className="lg:h-[35px] xl:h-[41px] 2xl:h-[46px] 3xl:h-[55px] h-[60px] lg:mb-[14px] xl:mb-[16px] 2xl:mb-[18px] 3xl:mb-[22px] mb-[25px] lg:ml-[33px] xl:ml-[37px] 2xl:ml-[42px] 3xl:ml-[51px] ml-[56.66px] lg:mt-[16px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] mt-[28px] object-contain lg:w-[35px] xl:w-[40px] 2xl:w-[45px] 3xl:w-[54px] w-[60px]"
                            compId="44:67"
                            comWidth={60}
                            comHeight={60}
                            compLeft={56.66}
                    ...
                    >
                      ...
                      >
                        ...
                        >{`ACCOUNTING`}</Text>
                        <Text
                          className="font-bold font-lora leading-lh xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.33px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] mt-[6.77px] 3xl:mt-[6px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                          compId="44:95"
                          comWidth={450}
                          comHeight={54.01}
                          compLeft={30}
                      ...
                      >
                        ...
                        >
                          ...
                          <Image
                            src={"images/img_btnbook_4.svg"}
                            className="lg:h-[35px] xl:h-[41px] 2xl:h-[46px] 3xl:h-[55px] h-[60px] lg:mb-[14px] xl:mb-[16px] 2xl:mb-[18px] 3xl:mb-[22px] mb-[25px] lg:ml-[29px] xl:ml-[33px] 2xl:ml-[38px] 3xl:ml-[45px] ml-[50.65px] lg:mt-[16px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] mt-[28px] object-contain lg:w-[35px] xl:w-[40px] 2xl:w-[45px] 3xl:w-[54px] w-[60px]"
                            compId="44:105"
                            comWidth={60}
                            comHeight={60}
                            compLeft={50.65}
