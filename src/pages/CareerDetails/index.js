          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Text
                    className="font-normal lg:mx-[35px] xl:mx-[40px] 2xl:mx-[45px] 3xl:mx-[54px] mx-[60px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_402 text-left w-[17%]"
                    compId="44:960"
                    comWidth={59}
                    comHeight={26}
                    compLeft={60}
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Text
                        className="font-bold text-black_900 text-center lg:text-fs12 xl:text-fs14 2xl:text-fs16 3xl:text-fs19 text-fs22 w-[100%]"
                        compId="44:977"
                        comWidth={197}
                        comHeight={28}
                        compLeft={0}
                      ...
                      >
                        <Text
                          className="font-normal xl:mx-[10px] 2xl:mx-[11px] 3xl:mx-[13px] mx-[15px] lg:mx-[8px] not-italic text-center xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-gray_700 w-[80%]"
                          compId="44:978"
                          comWidth={158}
                          comHeight={30}
                          compLeft={15}
                    ...
                    <Button
                      className="bg-bluegray_100 font-bold lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[22px] mt-[25px] 2xl:pb-[6px] 3xl:pb-[7px] pb-[8.545px] 2xl:pt-[5px] 3xl:pt-[6px] pt-[7.545px] lg:py-[4px] xl:py-[5px] rounded-radius60 text-bluegray_700 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 w-[100%]"
                      compId="44:979"
                      comWidth={214}
                      comHeight={47}
                      compLeft={0}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Text
                          className="font-bold lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] mb-[8px] text-black_901 lg:text-fs22 xl:text-fs25 2xl:text-fs28 3xl:text-fs34 text-fs38 text-left w-[17%]"
                          compId="47:16"
                          comWidth={52}
                          comHeight={49}
                          compLeft={0}
                        ...
                        >
                          ...
                          <Text
                            className="font-normal lg:ml-[44px] xl:ml-[51px] 2xl:ml-[57px] 3xl:ml-[69px] ml-[77px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_402 text-left w-[52%]"
                            compId="44:969"
                            comWidth={84}
                            comHeight={26}
                            compLeft={77}
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            />
                            <Text
                              className="font-bold lg:ml-[16px] xl:ml-[19px] 2xl:ml-[21px] 3xl:ml-[26px] ml-[29px] text-black_901 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[51%]"
                              compId="44:951"
                              comWidth={160}
                              comHeight={26}
                              compLeft={29}
                        ...
                        <Text
                          className="font-cairo font-normal lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6px] lg:mx-[26px] xl:mx-[30px] 2xl:mx-[33px] 3xl:mx-[40px] mx-[45px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_402 text-left w-[16%]"
                          compId="44:952"
                          comWidth={51}
                          comHeight={26}
                          compLeft={45}
                    ...
                    >
                      ...
                      />
                      <Text
                        className="font-bold lg:mb-[18px] xl:mb-[21px] 2xl:mb-[24px] 3xl:mb-[28px] mb-[32px] lg:ml-[16px] xl:ml-[19px] 2xl:ml-[21px] 3xl:ml-[26px] ml-[29px] text-black_901 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[63%]"
                        compId="44:959"
                        comWidth={78}
                        comHeight={26}
                        compLeft={29}
              ...
              >
                <Text
                  className="font-lora font-medium lg:mx-[16px] xl:mx-[19px] 2xl:mx-[21px] 3xl:mx-[26px] mx-[29px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[38%]"
                  compId="44:941"
                  comWidth={150}
                  comHeight={26}
                  compLeft={29}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Text
                      className="font-cairo font-normal ml-[1px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] mt-[10px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] not-italic text-bluegray_801 xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-left w-[67%]"
                      compId="44:929"
                      comWidth={287}
                      comHeight={30}
                      compLeft={1}
                  ...
                  >
                    <Button
                      className="bg-teal_50 font-bold 2xl:py-[10px] 3xl:py-[13px] py-[14.545px] lg:py-[8px] xl:py-[9px] rounded-radius60 text-bluegray_700 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 w-[63%]"
                      compId="44:982"
                      comWidth={143}
                      comHeight={60}
                      compLeft={0}
              ...
              >
                ...
                >
                  ...
                  >
                    <Text
                      className="font-medium text-bluegray_900 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[100%]"
                      compId="44:897"
                      comWidth={179}
                      comHeight={30}
                      compLeft={0}
              ...
              <Text
                className="font-bold font-lora lg:mt-[31px] xl:mt-[36px] 2xl:mt-[40px] 3xl:mt-[48px] mt-[54px] lg:mx-[35px] xl:mx-[40px] 2xl:mx-[45px] 3xl:mx-[54px] mx-[60px] text-black_900 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[5%]"
                compId="44:874"
                comWidth={64}
                comHeight={26}
                compLeft={60}
