            ...
            >
              ...
              >
                ...
                >
                  ...
                  >{`Latest Event`}</Text>
                  <Text
                    className="font-cairo font-normal lg:leading-lh16 xl:leading-lh18 2xl:leading-lh21 3xl:leading-lh25 leading-lh2800 mb-[1px] lg:ml-[37px] 2xl:ml-[48px] 3xl:ml-[57px] ml-[64px] lg:mr-[36px] 2xl:mr-[47px] 3xl:mr-[56px] mr-[63px] lg:mt-[11px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[17px] mt-[19.29px] xl:mx-[42px] not-italic text-center xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-white_A700 w-[81%]"
                    compId="36:379"
                    comWidth={531}
                    comHeight={54.02}
                    compLeft={64}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Text
                        className="font-semibold mx-[auto] text-bluegray_700 text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 uppercase w-[15%]"
                        compId="25:1483"
                        comWidth={204}
                        comHeight={43.41}
                        compLeft={283}
                    ...
                    <Text
                      className="font-normal lg:leading-lh18 xl:leading-lh21 2xl:leading-lh24 3xl:leading-lh28 leading-lh3200 lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] mt-[23.16px] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_700 w-[100%]"
                      compId="25:1454"
                      comWidth={1369}
                      comHeight={92.61}
                      compLeft={0}
              ...
              >
                ...
                >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >{`ACCOUNTING`}</Text>
                          <Text
                            className="capitalize font-bold font-lora leading-lh xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.33px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6.53px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                            compId="36:336"
                            comWidth={450}
                            comHeight={52.1}
                            compLeft={30}
                      ...
                      >
                        ...
                        >
                          ...
                          >{`MOBILE APP`}</Text>
                          <Text
                            className="font-bold font-lora xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.39px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6.53px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                            compId="36:298"
                            comWidth={449.94}
                            comHeight={27.02}
                            compLeft={30}
                      ...
                      >
                        ...
                        >
                          ...
                          >{`ART EXIBITHION`}</Text>
                          <Text
                            className="font-bold font-lora xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.39px] xl:mt-[3px] lg:mt-[3px] 2xl:mt-[4px] mt-[5.78px] 3xl:mt-[5px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left underline w-[88%]"
                            compId="36:317"
                            comWidth={449.94}
                            comHeight={27.02}
                            compLeft={30}
                        ...
                        >
                          <Text
                            className="font-bold lg:mb-[24px] 2xl:mb-[31px] 3xl:mb-[37px] mb-[41.48px] lg:ml-[24px] xl:ml-[28px] 2xl:ml-[31px] 3xl:ml-[37px] ml-[42px] lg:mt-[23px] 2xl:mt-[30px] 3xl:mt-[36px] mt-[40.52px] xl:my-[27px] lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left text-white_A700 w-[37%]"
                            compId="37:1148"
                            comWidth={81}
                            comHeight={27.01}
                            compLeft={42}
                      ...
                      >
                        ...
                        >
                          ...
                          >{`MOBILE APP`}</Text>
                          <Text
                            className="font-bold font-lora xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.39px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6.54px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                            compId="36:441"
                            comWidth={449.94}
                            comHeight={27.02}
                            compLeft={30}
                      ...
                      >
                        ...
                        >
                          ...
                          >{`ART EXIBITHION`}</Text>
                          <Text
                            className="font-bold font-lora xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.39px] xl:mt-[3px] lg:mt-[3px] 2xl:mt-[4px] mt-[5.79px] 3xl:mt-[5px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                            compId="36:460"
                            comWidth={449.94}
                            comHeight={27.02}
                            compLeft={30}
                      ...
                      >
                        ...
                        >
                          ...
                          >{`ACCOUNTING`}</Text>
                          <Text
                            className="font-bold font-lora leading-lh xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.33px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6.54px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                            compId="36:479"
                            comWidth={450}
                            comHeight={52.1}
                            compLeft={30}
                      ...
                      >
                        ...
                        >
                          ...
                          >{`ART EXIBITHION`}</Text>
                          <Text
                            className="font-bold font-lora xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.39px] xl:mt-[3px] lg:mt-[3px] 2xl:mt-[4px] mt-[5.78px] 3xl:mt-[5px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                            compId="36:519"
                            comWidth={449.94}
                            comHeight={27.02}
                            compLeft={30}
                      ...
                      >
                        ...
                        >
                          ...
                          >{`ACCOUNTING`}</Text>
                          <Text
                            className="font-bold font-lora leading-lh xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.33px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6.53px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                            compId="36:538"
                            comWidth={450}
                            comHeight={52.1}
                            compLeft={30}
                  ...
                  >
                    <Text
                      className="font-bold text-black_902 lg:text-fs35 xl:text-fs40 2xl:text-fs45 3xl:text-fs54 text-fs60 text-left w-[12%]"
                      compId="36:354"
                      comWidth={193}
                      comHeight={74.28}
                      compLeft={0}
                    ...
                    >
                      <Text
                        className="font-bold mb-[13.5px] lg:ml-[20px] xl:ml-[23px] 2xl:ml-[26px] 3xl:ml-[31px] ml-[35px] mt-[13.51px] 2xl:my-[10px] 3xl:my-[12px] lg:my-[7px] xl:my-[9px] text-bluegray_700 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[34%]"
                        compId="36:357"
                        comWidth={54}
                        comHeight={32.8}
                        compLeft={35}
                ...
                >
                  ...
                  >
                    <div className="bg-transparent border-0 w-[30%] input-wrap">
                      ...
                      />
                      <Input
                        className="placeholder:bg-transparent bg-white_A700 border-0 font-bold xl:pb-[13px] pb-[19.875px] lg:pl-[44px] xl:pl-[50px] 2xl:pl-[57px] 3xl:pl-[68px] pl-[76px] xl:pt-[12px] pt-[18.905px] lg:py-[11px] 2xl:py-[14px] 3xl:py-[17px] rounded-radius61 placeholder:text-bluegray_700 text-bluegray_700 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[100%]"
                        compId="37:26"
                        comWidth={0}
                        comHeight={51.13}
                        compLeft={0}
                    ...
                    >
                      ...
                      >
                        ...
                        >{`2`}</Text>
                        <Text
                          className="bg-bluegray_700 font-bold leading-lh lg:ml-[16px] xl:ml-[18px] 2xl:ml-[21px] 3xl:ml-[25px] ml-[28px] pb-[10.609863px] lg:pb-[6px] 2xl:pb-[7px] xl:pb-[7px] 3xl:pb-[9px] lg:pl-[15px] xl:pl-[17px] 2xl:pl-[19px] 3xl:pl-[23px] pl-[26px] lg:pr-[14px] xl:pr-[16px] 2xl:pr-[18px] 3xl:pr-[22px] pr-[25px] lg:pt-[4px] 2xl:pt-[5px] xl:pt-[5px] 3xl:pt-[6px] pt-[7.720215px] rounded-radius61 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-white_A701 w-[45%]"
                          compId="34"
                          comWidth={62}
                          comHeight={51.13}
                          compLeft={28}
                      ...
                      <Text
                        className="font-bold mb-[10.61px] lg:mb-[6px] 2xl:mb-[7px] xl:mb-[7px] 3xl:mb-[9px] lg:ml-[11px] xl:ml-[12px] 2xl:ml-[14px] 3xl:ml-[17px] ml-[19px] lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] mt-[7.72px] text-bluegray_700 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[5%]"
                        compId="37:19"
                        comWidth={11}
                        comHeight={32.8}
                        compLeft={19}
                    ...
                    >
                      <Text
                        className="font-bold mb-[10.61px] lg:mb-[6px] 2xl:mb-[7px] xl:mb-[7px] 3xl:mb-[9px] lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] mt-[7.72px] text-bluegray_700 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[32%]"
                        compId="37:22"
                        comWidth={37}
                        comHeight={32.8}
                        compLeft={0}
