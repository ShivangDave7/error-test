    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Stack
              className="absolute lg:h-[297px] xl:h-[339px] 2xl:h-[382px] 3xl:h-[458px] h-[508px] top-[0] w-[100%]"
              compId="1011"
              comWidth={1920}
              comHeight={508}
              compLeft={0}
            ...
            >
              <Image
                ...
                className="absolute lg:h-[297px] xl:h-[339px] 2xl:h-[382px] 3xl:h-[458px] h-[508px] inset-[0] object-cover w-[100%]"
                compId="37:411"
                comWidth={1920}
                comHeight={508}
                compLeft={0}
            ...
            >
              ...
              >{`Latest News`}</Text>
              <Text
                className="font-cairo font-normal lg:leading-lh16 xl:leading-lh18 2xl:leading-lh21 3xl:leading-lh25 leading-lh2800 lg:ml-[37px] 2xl:ml-[48px] 3xl:ml-[57px] ml-[64px] lg:mr-[36px] 2xl:mr-[47px] 3xl:mr-[56px] mr-[63px] lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] mt-[20px] xl:mx-[42px] not-italic text-center xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-white_A700 w-[81%]"
                compId="37:431"
                comWidth={531}
                comHeight={56}
                compLeft={64}
            ...
            <Row
              className="absolute bg-white_A700 bottom-[0] inset-x-[0] items-center justify-center mx-[auto] rounded-radius20 shadow-bs1 w-[42%]"
              compId="946"
              comWidth={806}
              comHeight={92}
              compLeft={0}
            ...
            >
              <Text
                className="font-normal lg:my-[16px] xl:my-[19px] 2xl:my-[21px] 3xl:my-[26px] my-[29px] not-italic text-black_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[13%]"
                compId="37:436"
                comWidth={101}
                comHeight={34}
                compLeft={0}
              ...
              <Image
                ...
                className="lg:h-[14px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] h-[24px] lg:ml-[327px] xl:ml-[374px] 2xl:ml-[421px] 3xl:ml-[505px] ml-[561px] lg:my-[19px] xl:my-[22px] 2xl:my-[25px] 3xl:my-[30px] my-[34px] object-contain lg:w-[14px] xl:w-[16px] 2xl:w-[18px] 3xl:w-[21px] w-[24px]"
                compId="37:433"
                comWidth={24}
                comHeight={24}
                compLeft={561}
          ...
          >
            ...
            >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <Text
                        className="capitalize font-bold font-lora leading-lh xl:ml-[20px] 3xl:ml-[27px] ml-[30px] xl:mr-[19px] 3xl:mr-[26px] mr-[29.33px] mt-[10px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] lg:mx-[17px] 2xl:mx-[22px] text-bluegray_801 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[88%]"
                        compId="37:244"
                        comWidth={450}
                        comHeight={54.01}
                        compLeft={30}
                    ...
                    >
                      <Button
                        className="bg-bluegray_700 font-bold lg:mb-[15px] xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] lg:ml-[17px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] ml-[30px] lg:mr-[186px] xl:mr-[213px] 2xl:mr-[240px] 3xl:mr-[288px] mr-[320.33px] lg:mt-[144px] xl:mt-[164px] 2xl:mt-[185px] 3xl:mt-[222px] mt-[247px] 2xl:pb-[10px] 3xl:pb-[12px] pb-[14px] lg:pb-[8px] xl:pb-[9px] 3xl:pt-[11px] pt-[13px] lg:pt-[7px] xl:pt-[8px] 2xl:pt-[9px] rounded-radius68 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_300 w-[31%]"
                        compId="37:252"
                        comWidth={159}
                        comHeight={45}
                        compLeft={30}
                  ...
                  >
                    ...
                    >
                      <Button
                        className="bg-bluegray_700 font-bold lg:mb-[15px] xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] lg:ml-[17px] xl:ml-[19px] 2xl:ml-[22px] 3xl:ml-[26px] ml-[29.67px] lg:mr-[199px] xl:mr-[227px] 2xl:mr-[256px] 3xl:mr-[307px] mr-[341.66px] lg:mt-[144px] xl:mt-[164px] 2xl:mt-[185px] 3xl:mt-[222px] mt-[247px] 2xl:pb-[10px] 3xl:pb-[12px] pb-[14px] lg:pb-[8px] xl:pb-[9px] 3xl:pt-[11px] pt-[13px] lg:pt-[7px] xl:pt-[8px] 2xl:pt-[9px] rounded-radius68 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_300 w-[27%]"
                        compId="37:463"
                        comWidth={138}
                        comHeight={45}
                        compLeft={29.67}
                  ...
                  >
                    ...
                    >
                      <Button
                        className="bg-bluegray_700 font-bold lg:mb-[15px] xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] lg:ml-[17px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] ml-[30.35px] lg:mr-[194px] xl:mr-[222px] 2xl:mr-[249px] 3xl:mr-[299px] mr-[332.98px] lg:mt-[144px] xl:mt-[164px] 2xl:mt-[185px] 3xl:mt-[222px] mt-[247px] 2xl:pb-[10px] 3xl:pb-[12px] pb-[14px] lg:pb-[8px] xl:pb-[9px] 3xl:pt-[11px] pt-[13px] lg:pt-[7px] xl:pt-[8px] 2xl:pt-[9px] rounded-radius68 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_300 w-[29%]"
                        compId="37:476"
                        comWidth={146}
                        comHeight={45}
                        compLeft={30.35}
                  ...
                  >
                    ...
                    >
                      <Button
                        className="bg-bluegray_700 font-bold lg:mb-[15px] xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] lg:ml-[17px] xl:ml-[19px] 2xl:ml-[22px] 3xl:ml-[26px] ml-[29.68px] lg:mr-[199px] xl:mr-[227px] 2xl:mr-[256px] 3xl:mr-[307px] mr-[341.65px] lg:mt-[144px] xl:mt-[164px] 2xl:mt-[185px] 3xl:mt-[222px] mt-[247px] 2xl:pb-[10px] 3xl:pb-[12px] pb-[14px] lg:pb-[8px] xl:pb-[9px] 3xl:pt-[11px] pt-[13px] lg:pt-[7px] xl:pt-[8px] 2xl:pt-[9px] rounded-radius68 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_300 w-[27%]"
                        compId="39:72"
                        comWidth={138}
                        comHeight={45}
                        compLeft={29.68}
              ...
              <Row
                className="absolute font-lora inset-x-[0] items-center justify-between mx-[auto] top-[3%] w-[84%]"
                compId="217:23"
                comWidth={1620}
                comHeight={77}
                compLeft={0}
              ...
              >
                <Text
                  className="font-bold text-black_902 lg:text-fs35 xl:text-fs40 2xl:text-fs45 3xl:text-fs54 text-fs60 text-left w-[10%]"
                  compId="37:395"
                  comWidth={155}
                  comHeight={77}
                  compLeft={0}
            ...
            >
              ...
              >
                <div className="bg-transparent border-0 w-[30%] input-wrap">
                  <Image
                    src={"images/img_chevron_1_2.svg"}
                ...
                >
                  ...
                  >{`Next`}</Text>
                  <Image
                    src={"images/img_chevron1_10.svg"}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  />
                  <Text
                    className="font-semibold xl:ml-[10px] 2xl:ml-[11px] 3xl:ml-[13px] ml-[15px] lg:ml-[8px] xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-gray_300 text-left w-[44%]"
                    compId="37:638"
                    comWidth={124}
                    comHeight={30}
                    compLeft={15}
                ...
                >
                  ...
                  />
                  <Text
                    className="font-semibold xl:ml-[10px] 2xl:ml-[11px] 3xl:ml-[13px] ml-[15px] lg:ml-[8px] xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-gray_300 text-left w-[51%]"
                    compId="37:644"
                    comWidth={144}
                    comHeight={30}
                    compLeft={15}
            ...
            >
              ...
              >
                <Text
                  className="font-semibold xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-left text-white_A700 w-[19%]"
                  compId="37:602"
                  comWidth={372}
                  comHeight={30}
                  compLeft={0}
                ...
                <Text
                  className="font-semibold xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-right text-white_A700 w-[10%]"
                  compId="37:604"
                  comWidth={186}
                  comHeight={30}
                  compLeft={0}
