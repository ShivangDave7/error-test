        ...
        >
          ...
          >
            ...
            >
              ...
              <Text
                className="font-cairo font-normal lg:ml-[159px] xl:ml-[182px] 3xl:ml-[245px] ml-[273px] lg:mr-[158px] xl:mr-[181px] 3xl:mr-[244px] mr-[272px] lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] mt-[20px] 2xl:mx-[204px] not-italic text-center xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-white_A700 w-[49%]"
                compId="41:23"
                comWidth={531}
                comHeight={28}
                compLeft={273}
          ...
          >
            ...
            >
              <Text
                className="capitalize font-bold lg:ml-[166px] xl:ml-[190px] 2xl:ml-[214px] 3xl:ml-[257px] ml-[286px] text-black_902 lg:text-fs23 xl:text-fs26 2xl:text-fs30 3xl:text-fs36 text-fs40 text-left w-[19%]"
                compId="41:209"
                comWidth={368}
                comHeight={80}
                compLeft={286}
              ...
              >
                <Text
                  className="font-bold lg:ml-[20px] xl:ml-[23px] 2xl:ml-[26px] 3xl:ml-[31px] ml-[35px] 2xl:my-[10px] 3xl:my-[12px] my-[14px] lg:my-[8px] xl:my-[9px] text-bluegray_700 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[34%]"
                  compId="41:247"
                  comWidth={54}
                  comHeight={34}
                  compLeft={35}
